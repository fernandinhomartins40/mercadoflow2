...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Extract + import Guanabara catalog")
    parser.add_argument("--max-pages", type=int, default=0)
    parser.add_argument("--max-records", type=int, default=0)
    parser.add_argument("--output", default="data/catalog/guanabara_web_br_catalog")
...
def main() -> int:
    ...
    result = run_guanabara_catalog_job(
        job,
        options,
