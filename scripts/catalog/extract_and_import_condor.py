...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Extract + import Condor catalog")
    parser.add_argument("--product-workers", type=int, default=12)
    parser.add_argument("--max-products", type=int, default=0)
    parser.add_argument("--output", default="data/catalog/condor_web_br_catalog")
...
def main() -> int:
    ...
    result = run_condor_catalog_job(job, options, product_workers=args.product_workers, max_products=args.max_products)
