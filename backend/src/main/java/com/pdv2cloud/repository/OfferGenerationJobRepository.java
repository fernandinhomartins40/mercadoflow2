...
public interface OfferGenerationJobRepository extends JpaRepository<OfferGenerationJob, UUID> {
    ...
    List<OfferGenerationJob> findTop50ByMarket_IdOrderByUpdatedAtDesc(UUID marketId);
    ...
    long countByMarket_IdAndStatusIn(UUID marketId, Collection<String> statuses);
}
