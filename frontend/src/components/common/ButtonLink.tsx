...
const ButtonLink: React.FC<ButtonLinkProps> = ({ variant = 'primary', className, children, ...props }) => {
  const baseClassName =
    'inline-flex h-12 min-h-12 max-h-12 items-center justify-center rounded-[14px] px-5 text-center text-sm font-semibold leading-none tracking-[-0.01em] no-underline whitespace-nowrap transition duration-200';
