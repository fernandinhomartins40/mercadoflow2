  ...
  return (
    <div
      className={desktopPinned
        ? 'workspace-root admin-workspace min-h-screen overflow-x-hidden bg-gray-50'
        : 'workspace-root admin-workspace flex min-h-screen flex-col overflow-x-hidden bg-gray-50'}
    >
