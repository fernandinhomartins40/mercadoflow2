  ...
  return (
    <div
      className={desktopPinned
        ? 'workspace-root super-admin-workspace grid min-h-screen grid-cols-[286px_minmax(0,1fr)] items-start gap-5 overflow-x-hidden bg-[radial-gradient(circle_at_top,#fff7f0_0%,#f8efe6_45%,#f1e6dc_100%)] p-5'
